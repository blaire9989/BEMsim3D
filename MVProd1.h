...
class MVProd1: public MVProd {
    public:
        ...
        Tfcomp e1, e2, const1, const21, const22, k1, k2;
        ...
        Tfcomp *d_hori_x, *d_hori_z, *d_hori_d, *d_vert_y, *d_vert_z, *d_vert_d, *d_hori_X, *d_hori_Z, *d_hori_D, *d_vert_Y, *d_vert_Z, *d_vert_D, *greens, *geometry;
        ...
        MVProd1(Estimate* est, Singular* singular, Grid* grid, bool isDielectric, int ind);
        void initializeNear();
        void initializeFar();
