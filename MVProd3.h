...
class MVProd3: public MVProd {
    public:
        ...
        Tfcomp *d_hori_x[4], *d_hori_z[4], *d_hori_d[4], *d_vert_y[4], *d_vert_z[4], *d_vert_d[4], *g0_data[2], *g1_data[2], *g2_data[2], *g3_data[2], *g4_data[2], *g5_data[2], *g6_data[2], *geo0_data[2], *geo1_data[2], *geo2_data[2];
        ...
        MVProd3(Estimate* est, Singular* singular, Grid* grid, int ind0, int ind1, int ind2, int ind3);
        void initializeNear();
        void initializeFar();
